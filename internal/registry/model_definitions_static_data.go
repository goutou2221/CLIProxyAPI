	...
	return []*ModelInfo{
		{
			...
			Type:                "copilot",
			DisplayName:         "GPT-4o",
			Description:         "GPT-4o via GitHub Copilot - Flagship multimodal model.",
			ContextLength:       128000,
		...
		},
		{
			...
			Description:         "GPT-4o Mini via GitHub Copilot - Affordable and intelligent small model.",
			ContextLength:       128000,
			MaxCompletionTokens: 16384,
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "o1",
			Description:         "o1 via GitHub Copilot - Reasoning model for complex tasks.",
			ContextLength:       200000,
		...
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "o1 Mini",
			Description:         "o1 Mini via GitHub Copilot - Fast reasoning model for focused tasks.",
			ContextLength:       128000,
			MaxCompletionTokens: 65536,
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "o3 Mini",
			Description:         "o3 Mini via GitHub Copilot - Small but capable reasoning model.",
			ContextLength:       200000,
			MaxCompletionTokens: 100000,
		},
		{
			...
			Description:         "Claude 3.5 Sonnet via GitHub Copilot - Intelligent model for complex tasks.",
			ContextLength:       200000,
			MaxCompletionTokens: 8192,
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "Claude 3.7 Sonnet",
			Description:         "Claude 3.7 Sonnet via GitHub Copilot - Most intelligent Claude 3 model.",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
		},
		{
			...
			Description:         "Gemini 2.0 Flash via GitHub Copilot - Fast multimodal model.",
			ContextLength:       1048576,
			MaxCompletionTokens: 8192,
		},
		{
			...
			Type:                "copilot",
			DisplayName:         "Gemini 2.5 Pro",
			Description:         "Gemini 2.5 Pro via GitHub Copilot - Most capable Gemini model.",
			ContextLength:       1048576,
			MaxCompletionTokens: 65536,
		},
	}
